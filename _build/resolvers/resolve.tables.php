...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('changepack_core_path', null, $modx->getOption('core_path') . 'components/changepack/') . 'model/';
            $modx->addPackage('changepack', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/changepack/model/schema/changepack.mysql.schema.xml';
