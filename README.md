...
ChangePack is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/ChangePack.git ./`
...
Now, you'll want to change references to ChangePack in the files in your
new copied-from-ChangePack repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'ChangePack' to whatever the
name of your component is.

## Copyright Information

ChangePack is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of ChangePack the ability to modify, distribute
